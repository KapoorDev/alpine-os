...
[ ! -f /root/.vnc/passwd ] && echo "No previous VNC password found. Setting hacknhaul as default password!" && mkdir -p /root/.vnc && x11vnc -storepasswd hacknhaul /root/.vnc/passwd || echo "Previously generated password found. Keeping your old password"
